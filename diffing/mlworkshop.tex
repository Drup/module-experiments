...
$O(\max(\mathrm{number\_of\_arguments},\mathrm{number\_of\_parameters})^2)$ module comparisons in the worse case.
This is fine in practice, since functors applications are usually short.
More efficient versions such as Myers algorithm (CITE) could also be used.
