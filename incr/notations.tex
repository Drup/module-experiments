...
\newcommand\Senrich[2]{{#2}_{\left[#1\right]}}
\newcommand\Sstrengthen[2]{#2/#1}
...
% Operation
\newcommand\Oreduce[2]{\llparenthesis #2 \rrparenthesis_{#1}}
\newcommand\Oenrich[3]{\Oreduce{#1}{\Senrich{#2}{#3}}}
\newcommand\Ostrengthen[3]{\Oreduce{#1}{\Sstrengthen{#2}{#3}}}
\newcommand\Osubst[3]{\Oreduce{#1}{\Ssubst{#2}{#3}}}
